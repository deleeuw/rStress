...
hl <- fStress(ekmanMatrix, xini = xinit, f = flog, g = glog, verbose = FALSE)
hp1 <- fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = .1, verbose = FALSE)
hp5 <- fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = .5, verbose = FALSE)
h1 <- fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = 1, verbose = FALSE)
h2 <- fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = 2, verbose = FALSE)
h5 <- fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = 5, verbose = FALSE)
he <- fStress(ekmanMatrix, xini = xinit, f = fexp, g = gexp, verbose = FALSE)
```
