...
\begin{verbatim}
function (theData, xinit = NULL, ndim = 2, f = fPower, g = gPower, 
    rpow = 1, ties = 1, ordinal = FALSE, itmax = 10000, eps = 1e-06, 
    verbose = TRUE) 
NULL
\end{verbatim}
...
Unit: microseconds
 ...
 fStress(ekmanMatrix, xini = xinit, f = fPower, g = gPower, r = 0.1,      verbose = FALSE)
  ...
  1368.006  1470.280  1782.5049  1522.4735  1563.925  5717.450   100  a 
   381.464   395.363   441.3892   412.5625   486.752   607.702   100  a 
 33755.013 37817.908 43840.4107 38643.0125 39699.993 83263.620   100   b
  3379.343  3630.325  3670.5963  3684.0140  3720.771  3818.494   100  a 
 32748.258 36561.217 45443.7825 37440.7900 39205.676 82820.287   100   b
  3351.299  3514.889  3550.7976  3549.0420  3588.300  3670.361   100  a 
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp1c-1.pdf}}

}

\caption{Configuration Plot, Metric, r = .1}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp1s-1.pdf}}

}

\caption{Shepard Plot, Metric, r = .1}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp5c-1.pdf}}

}

\caption{Configuration Plot, Metric, r = .5}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp5s-1.pdf}}

}

\caption{Shepard Plot, Metric, r = .5}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch1c-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch1s-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch2c-1.pdf}}

}

\caption{Configuration Plot, Metric, r = 2}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch2s-1.pdf}}

}

\caption{Shepard Plot, Metric, r = 2}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch5c-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch5s-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp1oc-1.pdf}}

}

\caption{Configuration Plot, Non-metric, r = .1}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp1os-1.pdf}}

}

\caption{Shepard Plot, Non-metric, r = .1}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp5oc-1.pdf}}

}

\caption{Configuration Plot, Non-metric, r = .5}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/chp5os-1.pdf}}

}

\caption{Shepard Plot, Non-metric, r = .5}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch1oc-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch1os-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch2oc-1.pdf}}

}

\caption{Configuration Plot, Non-metric, r = 2}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch2os-1.pdf}}

}

\caption{Shepard Plot, Non-metric, r = 2}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch5oc-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{rStress_files/figure-pdf/ch5os-1.pdf}}
