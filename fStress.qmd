...
The Multidimensional Scaling (MDS) loss function stress, origiunally proposed by @kruskal_64a, @kruskal_64b, is defined as
\begin{equation}
...
Suppose $f$ is a real-valued function defined of $[0,+\infty)$ such that

* $f$ is strictly increasing,
* $f$ is continuously differentiable,
* $f(0) = 0$.

Examples are $f(z)=\exp(rz)-1$, $f'(z)=r\exp(rz)$
$f(z)=\log(r z+1)$, $f'(z)=r(rz+1)^{-1}$
$f(z)=1-\exp(-r z)$ $f'(z)=r\exp(-rz)$
and $f(z)=z^r$ $f'(z)=rz^{r-1}$
...
\end{equation}
with $f$ strictly increasing and differentiable in the open interval $(0,+\infty)$.
Moreover we assume that $f(0)=0$, so that  
